...
created: 2026-09-04
updated: 2026-09-04
sources: ["[[Ino Yamanaka (source)]]", "[[Sai (source)]]", "[[Team 10 (Asuma) (source)]]"]
---
...
A Yamanaka mind-technique specialist: the Mind Body Switch Technique (possessing a target), advanced sensory perception for detecting chakra signatures, and the long-range Mind Body Transmission Technique that lets her run telepathic communication networks across the entire village — the skillset that makes her indispensable during the current crisis.

## Key arcs

- **Chūnin Exams / Sasuke Recovery Mission**: friendship with Sakura solidifies through Team 10's "Formation Ino–Shika–Chō" (with Shikamaru Nara and [[Chōji Akimichi]]).
- **New Era**: leads the rebuilt village sensory network after the war, marries [[Sai]], has a son (Inojin), and becomes the operational hub relaying threat alerts through the Kawaki Arc (Delta, Jigen, Isshiki) — corroborated by [[Sai (source)]] and [[Team 10 (Asuma) (source)]].
